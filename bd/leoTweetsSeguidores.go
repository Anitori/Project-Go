...
//Lee los tweets de mis seguidores
func LeoTweetsSeguidores(ID string, pagina int) ([]models.DevuelvoTweetsSeguidores, bool){
	...
	condiciones = append(condiciones, bson.M{
		"$lookup": bson.M{
			"from": "tweet", //Vamos a poner con que tabla queremos unir nuestra tabla relacion
		...
		condiciones = append(condiciones, bson.M{"$skip": skip}) //Primero hago el skip y despues el limit
